...
typedef enum { READING,
    WRITING,
    LIST_READING,
    LIST_WRITING } unit_mode;

typedef enum { BLANK_NULL,
    BLANK_ZERO,
    BLANK_UNSPECIFIED } unit_blank;

typedef enum { SIGN_PROCDEFINED,
    SIGN_SUPPRESS,
    SIGN_PLUS,
    SIGN_UNSPECIFIED } unit_sign;

typedef enum { ADVANCE_YES,
    ADVANCE_NO,
    ADVANCE_UNSPECIFIED } unit_advance;

typedef enum { BT_UNKNOWN = 0,
    BT_INTEGER,
    BT_LOGICAL,
    BT_REAL,
    BT_COMPLEX,
